...
private slots:
    ...
    QString BuyEarnzCoin(QString OrderType, double Quantity, double Rate);
    QString SellEarnzCoin(QString OrderType, double Quantity, double Rate);
