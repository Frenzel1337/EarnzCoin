...
public:
    ...
    QLabel *label232_2;
    QLabel *EarnzCoinAvailableLabel;
    QLabel *labelEarnzCoin;
    QPushButton *Buy_Max_Amount;
    QLineEdit *UnitsInput;
    QLabel *label_4;
    QPushButton *Sell_Max_Amount;
    QLineEdit *UnitsInputEarnzCoin;
    QLabel *label_22;
    QLabel *label_6;
    ...
    QLabel *label_17;
    QPushButton *BuyEarnzCoin;
    QPushButton *SellEarnzCoinBTN;
    QTableWidget *BidsTable;
    QLabel *BtcDemand;
    QLabel *AsksCount;
    QLabel *BtcSupply;
    QLabel *EarnzCoinDemand;
    QLabel *EarnzCoinSupply;
    QLabel *BidsCount;
    QWidget *tab;
    ...
    QLabel *label_11;
    QLabel *EarnzCoinBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *EarnzCoinAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *EarnzCoinPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        EarnzCoinAvailableLabel = new QLabel(BuyTab);
        EarnzCoinAvailableLabel->setObjectName(QStringLiteral("EarnzCoinAvailableLabel"));
        QPalette palette1;
        ...
        EarnzCoinAvailableLabel->setPalette(palette1);
        EarnzCoinAvailableLabel->setFont(font3);
        EarnzCoinAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(EarnzCoinAvailableLabel);

        labelEarnzCoin = new QLabel(BuyTab);
        labelEarnzCoin->setObjectName(QStringLiteral("labelEarnzCoin"));
        labelEarnzCoin->setFont(font3);

        horizontalLayout->addWidget(labelEarnzCoin);
        ...
        UnitsInputEarnzCoin = new QLineEdit(BuyTab);
        UnitsInputEarnzCoin->setObjectName(QStringLiteral("UnitsInputEarnzCoin"));
        UnitsInputEarnzCoin->setMinimumSize(QSize(0, 0));
        UnitsInputEarnzCoin->setFont(font5);

        gridLayout_6->addWidget(UnitsInputEarnzCoin, 4, 9, 1, 1);
        ...
        BuyEarnzCoin = new QPushButton(BuyTab);
        BuyEarnzCoin->setObjectName(QStringLiteral("BuyEarnzCoin"));

        gridLayout_6->addWidget(BuyEarnzCoin, 7, 3, 1, 1);

        SellEarnzCoinBTN = new QPushButton(BuyTab);
        SellEarnzCoinBTN->setObjectName(QStringLiteral("SellEarnzCoinBTN"));

        gridLayout_6->addWidget(SellEarnzCoinBTN, 7, 9, 1, 1);
        ...
        EarnzCoinDemand = new QLabel(BuyTab);
        EarnzCoinDemand->setObjectName(QStringLiteral("EarnzCoinDemand"));
        QFont font6;
        font6.setPointSize(8);
        EarnzCoinDemand->setFont(font6);
        EarnzCoinDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(EarnzCoinDemand, 0, 1, 1, 5);

        EarnzCoinSupply = new QLabel(BuyTab);
        EarnzCoinSupply->setObjectName(QStringLiteral("EarnzCoinSupply"));
        EarnzCoinSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(EarnzCoinSupply, 0, 9, 1, 3);
        ...
        BittrexEarnzCoinLabel = new QLabel(tab);
        BittrexEarnzCoinLabel->setObjectName(QStringLiteral("BittrexEarnzCoinLabel"));
        QPalette palette7;
        ...
        BittrexEarnzCoinLabel->setPalette(palette7);
        BittrexEarnzCoinLabel->setFont(font7);
        BittrexEarnzCoinLabel->setAutoFillBackground(false);
        BittrexEarnzCoinLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexEarnzCoinLabel);
        ...
        EarnzCoinBalanceLabel = new QLabel(BalanceTab);
        EarnzCoinBalanceLabel->setObjectName(QStringLiteral("EarnzCoinBalanceLabel"));
        EarnzCoinBalanceLabel->setFont(font4);
        EarnzCoinBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(EarnzCoinBalanceLabel, 0, 3, 1, 1);
        ...
        EarnzCoinAvailableLabel_2 = new QLabel(BalanceTab);
        EarnzCoinAvailableLabel_2->setObjectName(QStringLiteral("EarnzCoinAvailableLabel_2"));
        EarnzCoinAvailableLabel_2->setFont(font4);
        EarnzCoinAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(EarnzCoinAvailableLabel_2, 1, 3, 1, 1);
        ...
        EarnzCoinPendingLabel = new QLabel(BalanceTab);
        EarnzCoinPendingLabel->setObjectName(QStringLiteral("EarnzCoinPendingLabel"));
        EarnzCoinPendingLabel->setFont(font4);
        EarnzCoinPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(EarnzCoinPendingLabel, 2, 3, 1, 1);
        ...
        EarnzCoinBalanceLabel->raise();
        EarnzCoinAvailableLabel_2->raise();
        EarnzCoinPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "ERZ Available:", 0));
        EarnzCoinAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelEarnzCoin->setText(QApplication::translate("tradingDialog", " ERZ", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "ERZ", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "ERZ", 0));
        ...
        BuyEarnzCoin->setText(QApplication::translate("tradingDialog", "Buy ERZ", 0));
        SellEarnzCoinBTN->setText(QApplication::translate("tradingDialog", "Sell ERZ", 0));
        ...
        EarnzCoinDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 ERZ", 0));
        EarnzCoinSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 ERZ", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in ERZ:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "ERZ", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "ERZ Balance:", 0));
        BittrexEarnzCoinLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "ERZ", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "ERZ Balance:", 0));
        EarnzCoinBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "ERZ Available:", 0));
        EarnzCoinAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "ERZ Pending:", 0));
        EarnzCoinPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate ERZ Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw ERZ:", 0));
