...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About EarnzCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>EarnzCoin</b> version", 0));
...
"Copyright \302\251 2017-2018 The EarnzCoin developers", 0));
